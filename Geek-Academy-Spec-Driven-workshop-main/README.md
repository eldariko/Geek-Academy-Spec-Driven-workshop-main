...
4. For the MCP server lab, continue with [lab2.md](lab2.md).

## Architecture Docs

- [support-agent-python/ARCHITECTURE.md](support-agent-python/ARCHITECTURE.md)
- [support-ops-mcp-python/ARCHITECTURE.md](support-ops-mcp-python/ARCHITECTURE.md)
